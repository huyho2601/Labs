...
Download the kioptrix rar file from vulnhub website (https://www.vulnhub.com/entry/kioptrix-level-1-1,22/). Unzip the rar file and run .vmx file on VMWare. There is an issue that even though I changed the network connection to **NAT** in settings, the .vmx file always automatically switched back to **Bridged**
